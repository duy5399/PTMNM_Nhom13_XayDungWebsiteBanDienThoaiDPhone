...
@section('content')
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<?php 
          ...
          $oder = DB::table('bill')->count('*'); 
          $order_new = DB::table('bill')->where('status',0)->count('*'); 
          $product = DB::table('product')->count('*');            
          $member = DB::table('users')->count('*');            
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h4>Đơn hàng mới</h4>
						<div class="easypiechart" id="easypiechart-blue" data-percent="{{$order_new/$oder}}" ><span class="percent">{{$order_new/$oder}} %</span>
						</div>
					</div>
				</div>
			</div>
